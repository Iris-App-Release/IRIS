...
## [2026-06-02] revert+resimplify | Enclosures drop the forward dolly + merged look — grid worlds now use Earth's EXACT camera physics (telephoto zoom + frozen proximity gate), with only a capped look to anchor the rim
